...
struct ContentView: View {
    @ObservedObject var gameScene: GameScene = GameScene(size: CGSize(width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height), configuration: LevelConfig.levels[0])
